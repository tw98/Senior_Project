...
parser.add_argument('--summary_file', type=str, default='results/fMRI_manifoldAE_paper_result_summary.csv')

SUMMARYFILE = 'results/fMRI_manifoldAE_paper_result_summary.csv'
...
def main():
    ...
    if args.downstream:
        ...
        cols = ['data', 'n_pt', 'train_half', 'common_hiddendim', 'manifold_embed_dim',
                'common_latent_regularization', 'lambda_common', 'manifold_regularization', 'lambda_mani',
